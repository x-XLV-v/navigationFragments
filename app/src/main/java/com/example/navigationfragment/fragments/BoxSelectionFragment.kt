...
import com.example.navigationfragment.databinding.FragmentBoxSelectionBinding
import com.example.navigationfragment.databinding.ItemBoxBinding
...
class BoxSelectionFragment: Fragment(), HasCustomTitle {
    ...
    private fun getRemainingSeconds(): Long {
        ...
        return max(0, (finishedAt - System.currentTimeMillis()) / 100)
    }
    ...
    inner class TimerHandler {
        ...
        fun onStart() {
            ...
            timer = object : CountDownTimer(getRemainingSeconds() * 100, 1) {
